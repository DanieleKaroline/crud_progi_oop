 ...
 * @author natal
 */
public class Frms extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Possue cadastro e quer fazer login? Clique!");

        jLabel3.setText("Não possuí cadastro? Cadastre-se! ");

        jPanel2.setBackground(new java.awt.Color(131, 131, 173));
    ...
    private void BtnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLoginActionPerformed
        ...
        JComponent comp = (JComponent) evt.getSource();             //para fechar o as opcoes qnd logar de logar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
